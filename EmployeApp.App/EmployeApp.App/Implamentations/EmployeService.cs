using EmployeApp.App.Interfaces;
using EmployeApp.Core.Models;
using Employe1.Data.Repositories;
using System;
...
using Employe1.Data.Repository;
using System.Security.Cryptography.X509Certificates;

namespace EmployeApp.App.Implamentations
{
    public class EmployeService : IEmployeServices
    {
         private readonly Repository<Employe> _repository = new Repository<Employe>();
